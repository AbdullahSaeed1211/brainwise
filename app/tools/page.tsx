...
export default function ToolsPage() {
  ...
  const toolsData: Tool[] = [
    ...
    },
    {
      ...
      component: <ComingSoonComponent title="Neuroscience Mini-Courses" />,
      category: "education",
    ...
    <div className="container px-4 py-8 md:py-12">
      ...
      <ResponsiveTabs defaultValue={activeCategory} value={activeCategory} onValueChange={setActiveCategory} className="w-full">
        <div className="flex justify-center mb-6">
          <ResponsiveTabsList>
            <ResponsiveTabsTrigger value="training" className="rounded-md">Training</ResponsiveTabsTrigger>
            <ResponsiveTabsTrigger value="assessment" className="rounded-md">Assessment</ResponsiveTabsTrigger>
